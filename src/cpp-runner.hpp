...
namespace detersl {
    namespace runner {
        ...
        class CPPRunner : public Runner {
            public:
                CPPRunner(acquired_cown_span<detersl::types::Resource> cown_arr, detersl::func::CPPFuncInfo func_info) : 
                    func_info_(func_info),
                    func_(func_info),
                    Runner(cown_arr, func_info) {}

                CPPRunner(acquired_cown_span<detersl::types::Resource> cown_arr,
